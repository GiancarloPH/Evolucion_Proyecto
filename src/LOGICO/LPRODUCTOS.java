    ...
    public void consultarPro (){
        try{
            ...
            while(con.getRs().next()) {                                
                PRODUCTOS temp =new PRODUCTOS(con.getRs().getString(1),con.getRs().getString(2), 
                con.getRs().getString(3), Double.parseDouble(con.getRs().getString(4)),
                Integer.parseInt(con.getRs().getString(5)), Integer.parseInt(con.getRs().getString(6)), con.getRs().getString(7));
                Lprod.add(temp);   
            }
        } catch(Exception e) {
        }
